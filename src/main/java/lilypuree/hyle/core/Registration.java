...
import lilypuree.hyle.world.feature.DeepslateReplacer;
import lilypuree.hyle.world.feature.DeepslateReplacerConfiguration;
...
public class Registration {
    ...
    public static final RegistryObject<Feature<DeepslateReplacerConfiguration>> DEEPSLATE_REPLACER = FEATURES.register("deepslate_replacer", () -> new DeepslateReplacer());
